...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   dopMenu: function() { return /* binding */ dopMenu; }
/* harmony export */ });
var dopMenu = function dopMenu() {
  var plusButton = document.querySelector('.phone__plus');
  var toggleMenu = document.querySelector('.phone__dop-menu');
  if (plusButton) {
...
var Header = /*#__PURE__*/function () {
  function Header() {
    ...
    this._close = document.querySelector('.phone__close');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hiddenPass: function() { return /* binding */ hiddenPass; }
/* harmony export */ });
var hiddenPass = function hiddenPass() {
  document.querySelectorAll('.js-toggle-password').forEach(function (button) {
    var input = button.parentElement.querySelector('.js-password-input');
...
/***/ "./js/modules/init-change-menu.js":
/*!****************************************!*\
  !*** ./js/modules/init-change-menu.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initChangeMenu: function() { return /* binding */ initChangeMenu; }
/* harmony export */ });
var initChangeMenu = function initChangeMenu() {
  var changeButton = document.getElementById('change');
  var changeSection = document.querySelector('.full2');
  var changeClose = document.querySelector('.full2__close');
  var changeBody = document.querySelector('body');
  changeButton.addEventListener('click', function () {
    changeSection.classList.add('open');
    changeBody.classList.add('open');
  });
  changeClose.addEventListener('click', function () {
    changeSection.classList.remove('open');
    changeBody.classList.remove('open');
  });
};
...
/* harmony export */ });
var sliderContacts = document.querySelector('[data-slider="contacts"]');
var swiper;
var initContactsSlider = function initContactsSlider() {
  if (window.innerWidth <= 1278) {
    ...
    if (!swiper) {
      swiper = new Swiper(sliderContacts, {
        slidesPerView: 1,
        spaceBetween: 20,
        navigation: {
          nextEl: '.swiper-button-next.contacts__next',
          prevEl: '.swiper-button-prev.contacts__prev'
        }
      });
    }
  } else {
...
window.addEventListener('resize', initContactsSlider);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initHi: function() { return /* binding */ initHi; }
/* harmony export */ });
var initHi = function initHi() {
  document.querySelectorAll('.custom-select').forEach(function (select) {
    select.addEventListener('click', function () {
      var leftBlock = document.querySelector('.lk__left');
      leftBlock.style.minHeight = "".concat(document.querySelector('.lk__right').scrollHeight, "px");
    });
  });
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initHow: function() { return /* binding */ initHow; }
/* harmony export */ });
var initHow = function initHow() {
  ...
  window.addEventListener('resize', function () {
    if (window.innerWidth > 768) {
      document.querySelectorAll('.accordion-content.show').forEach(function (content) {
        content.classList.remove('show');
      });
      document.querySelectorAll('.accordion-header.active').forEach(function (header) {
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="catalog"]');
var initInfoSlider = function initInfoSlider() {
  ...
  var swiper = new Swiper(slider, {
    ...
    // autoHeight: true,
    navigation: {
      nextEl: '.swiper-button-next.catalog__next',
      prevEl: '.swiper-button-prev.catalog__prev'
    },
    breakpoints: {
      280: {
        slidesPerView: 1
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRubber: function() { return /* binding */ initRubber; }
/* harmony export */ });
var initRubber = function initRubber() {
  var textarea = document.querySelector('#chat-form .custom-textarea textarea');
  var formContent = document.querySelector('.phone__form-content');
  if (textarea) {
    textarea.addEventListener('input', function () {
      this.style.height = '25px';
      this.style.height = this.scrollHeight + 'px';
      if (this.scrollHeight > 28) {
        formContent.style.minHeight = this.scrollHeight + 26 + 'px';
      } else {
        formContent.style.minHeight = '25px';
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initTimer: function() { return /* binding */ initTimer; }
/* harmony export */ });
var initTimer = function initTimer() {
  var timeLeft = 44;
  var timerElement = document.getElementById('sms-timer');
...
/* harmony import */ var _modules_hidden_pass__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/hidden-pass */ "./js/modules/hidden-pass.js");
/* harmony import */ var _modules_init_timer__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-timer */ "./js/modules/init-timer.js");
/* harmony import */ var _modules_init_hi__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/init-hi */ "./js/modules/init-hi.js");
/* harmony import */ var _modules_init_how__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/init-how */ "./js/modules/init-how.js");
/* harmony import */ var _modules_init_rubber__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/init-rubber */ "./js/modules/init-rubber.js");
/* harmony import */ var _modules_dop_menu__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/dop-menu */ "./js/modules/dop-menu.js");
/* harmony import */ var _modules_init_change_menu__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/init-change-menu */ "./js/modules/init-change-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_hidden_pass__WEBPACK_IMPORTED_MODULE_13__.hiddenPass)();
    (0,_modules_init_timer__WEBPACK_IMPORTED_MODULE_14__.initTimer)();
    (0,_modules_init_hi__WEBPACK_IMPORTED_MODULE_15__.initHi)();
    (0,_modules_init_how__WEBPACK_IMPORTED_MODULE_16__.initHow)();
    (0,_modules_init_rubber__WEBPACK_IMPORTED_MODULE_17__.initRubber)();
    (0,_modules_dop_menu__WEBPACK_IMPORTED_MODULE_18__.dopMenu)();
    (0,_modules_init_change_menu__WEBPACK_IMPORTED_MODULE_19__.initChangeMenu)();
  });
});
}();
/******/ })()
